...
<div class="hero">
    ...
    <p>I some random dude who likes to edit stuff for fun</p>
...
<section id="about">
    ...
    <p style="text-align:center; max-width:700px; margin:auto; opacity:0.85;">
        I'm a 15 yo kid with an abnormal height, idk tf happed when i was in 7-8th grade
      i love my girlfriend ong she's so fucking majestic ahhh
    </p>
</section>
...
<section id="projects">
    ...
    <div class="projects">
        <div class="card">
            <h3>Project One</h3>
            <p>Idk checkout my Instagram or something.</p>
        </div>
        <div class="card">
            <h3>Project Two</h3>
            <p>Checkout my Instagram </p>
        </div>
        <div class="card">
            <h3>Project Three</h3>
            <p>you should definitely ck out my ig.</p>
        </div>
    </div>
</section>
...
<section id="contact">
    ...
    <p style="text-align:center;">
        Email: femboytwinkieballss.com <br><br>
